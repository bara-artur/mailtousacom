  ...
  'components' => [
    ...
    'urlManager' => [
        ...
        'rules' => [
          ...
          '<action:(top|shop|about|blog|legends|mans|competitions|onlinehelp|archive)>' => 'site/<action>',
          ...
          'ebay/<action:get-order|connection|get-token|track-update|test>/<id:\d+>'=>'ebay/default/<action>/',
