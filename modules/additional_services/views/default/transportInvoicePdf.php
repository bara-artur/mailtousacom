...
<table border="1" width="100%">
  ...
  <tr>
    <td>
      Get discounts by referring a friend
      <div style="float: right; display: inline-block;width: 50px;">
        <?=$data['ref_code'];?>
      </div>
    </td>
    <td>
...
<table width="100%">
  ...
  <tr>
    ...
    <td>QST</td>
    <td><?=number_format($total['qst'],2,'.','');?></td>
  </tr>
  <tr>
