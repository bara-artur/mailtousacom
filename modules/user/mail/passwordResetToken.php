...
<style id="builder-styles">body {
    ...
    }</style></head><body style="background: rgb(204, 204, 204); padding: 50px 5px;"><table width="640" cellspacing="0" cellpadding="0" border="0" align="center" data-type="image" class="main" style="display: table; background-color: rgb(255, 255, 255);"><tbody><tr><td align="center" class="image" style="padding: 15px 50px;"><img border="0" src="http://mailtousa.com/img/mailtousa.png" tabindex="0" style="display: block; width: 240px;height:32px;"></td></tr></tbody></table>    <table width="640" cellspacing="0" cellpadding="0" border="0" align="center" data-type="divider" class="main" style="border: 0px; display: table; background-color: rgb(255, 255, 255);"><tbody><tr><td class="divider-simple" style="padding: 2px 50px 0px;"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="border-top: 1px solid rgb(218, 223, 225);"><tbody><tr><td width="100%" height="15px"></td></tr></tbody></table></td></tr></tbody></table>    <table width="640" cellspacing="0" cellpadding="0" border="0" align="center" data-type="text-block" class="main" style="display: table; background-color: rgb(255, 255, 255);"><tbody><tr><td data-block-id="background" align="left" class="block-text" style="font-size: 13px; color: rgb(0, 0, 0); line-height: 22px; padding: 10px 50px;font-family: Arial, serif;"><p style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;" data-block-id="text-area" data-mce-style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;"><span style="font-size: 14pt;" data-mce-style="font-size: 14pt;">Hello !</span></p><p style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;" data-block-id="text-area" data-mce-style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;"><span style="font-size: 12pt;" data-mce-style="font-size: 12pt;">Formed a request to the following </span><span style="font-size: 12pt;" data-mce-style="font-size: 12pt;">password settings on the site:</span></p><p style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;" data-block-id="text-area" data-mce-style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;"><span style="font-size: 12pt;" data-mce-style="font-size: 12pt;"><b> <?= Html::encode($password)?></b></span></p><p style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;" data-block-id="text-area" data-mce-style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;"><span style="font-size: 12pt;" data-mce-style="font-size: 12pt;">To activate it, and authorization for a new password,click</span></p></td></tr></tbody></table>    <table width="640" cellspacing="0" cellpadding="0" border="0" bgcolor="#FFFFFF" align="center" data-type="button" class="main" style="display: table; background-color: rgb(255, 255, 255);"><tbody><tr><td class="buttons-full-width" style="padding: 15px 50px;"><table cellspacing="0" cellpadding="0" border="0" align="center" class="button"><tbody><tr><td class="button" style="margin: 10px;"><a href="<?=$confirmLink;?>" data-default="1" class="button-1" style="color: rgb(255, 255, 255); font-family: Arial, serif; font-size: 15px; line-height: 21px; border-radius: 0px; text-align: center; text-decoration: none; font-weight: bold; display: block; margin: 0px; padding: 12px 20px; background-color: rgb(0, 106, 193);">ACTIVATE NEW PASSWORD</a></td></tr></tbody></table></td></tr></tbody></table>    <table width="640" cellspacing="0" cellpadding="0" border="0" align="center" data-type="text-block" class="main" style="display: table; background-color: rgb(250, 104, 0);"><tbody><tr><td data-block-id="background" align="left" class="block-text" style="font-size: 13px; color: rgb(0, 0, 0); line-height: 22px; padding: 10px 50px 0px;font-family: Arial, serif;"><p style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;" data-block-id="text-area" data-mce-style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;"><strong><span style="font-size: 12pt; color: rgb(255, 255, 255);" data-mce-style="font-size: 12pt; color: #ffffff;">If you didn't send a request of dumping of the password, </span></strong></p><p style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;" data-block-id="text-area" data-mce-style="margin: 0px 0px 10px; line-height: 22px; font-size: 13px; text-align: center;"><strong><span style="font-size: 12pt; color: rgb(255, 255, 255);" data-mce-style="font-size: 12pt; color: #ffffff;">then don't activate the new password at all</span></strong></p></td></tr></tbody></table>    <table width="640" cellspacing="0" cellpadding="0" border="0" align="center" data-type="text-block" class="main" style="display: table; background-color: rgb(238, 238, 238);"><tbody><tr><td data-block-id="background" align="left" style="font-family: Arial, serif; font-size: 13px; color: rgb(0, 0, 0); line-height: 22px; padding: 10px 50px;"><p style="text-align: center;" data-mce-style="text-align: center;">MailToUsa.com</p></td></tr></tbody></table>
